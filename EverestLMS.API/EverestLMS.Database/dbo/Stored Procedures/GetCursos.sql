...
BEGIN
SET NOCOUNT ON;
	SELECT c.IdCurso, c.Nombre, c.Descripcion, e.Descripcion as DescripcionEtapa, e.Nombre as NombreEtapa, d.Descripcion as DificultadDescripcion, c.IdEtapa,
	i.Descripcion as IdiomaDescripcion, l.Descripcion as LineaCarreraDescripcion, n.Descripcion as NivelDescripcion, c.IdDificultad, c.Idioma, c.Puntaje, c.Imagen, c.Autor 
    FROM curso c 
